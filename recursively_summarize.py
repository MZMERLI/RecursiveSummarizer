...
interviews_df = pd.read_csv('D:/Dataset DeepFake/LIAR dataset/train.tsv', sep='\t')

    
if __name__ == '__main__':
    #alltext = open_file('input.txt')
    result = list(['Data generated by GPT-3'])
    for i in range(0, 5000): # nombre de textes/lignes à traiter   
        alltext = interviews_df['statement'][i]
        #chunks = textwrap.wrap(item.split('\n') for item in alltext)
